...
public enum ErrorCodes { // enum est une class contient des constante unchamgable comme final
	...
	UTLISATEUR_NOT_FOUND(12000),
	UTLISATEUR_NOT_VALID(12001),
