...
public class InvalidEntityException extends RuntimeException { // l'orsque on essaye de souvgarder qca chose dans la base de donnee et on passe par la validation mais on trouve que cette chose nest pas valide 
